...
- Usage: Reference from command with `@/Users/hokang2father/projects/referio-platform/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/hokang2father/projects/referio-platform/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/hokang2father/projects/referio-platform/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
