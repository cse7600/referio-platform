...
- **Global scope**: `/Users/hokang2father/projects/referio-platform/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/hokang2father/projects/referio-platform/.claude/notes/`)
...
2. Glob `/Users/hokang2father/projects/referio-platform/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/hokang2father/projects/referio-platform/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/hokang2father/projects/referio-platform/.claude/notes/` — works in any directory
