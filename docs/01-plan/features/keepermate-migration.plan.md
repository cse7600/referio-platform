...
| 날짜 | 대상 | 제목 | 발송수 | 스크립트 |
|------|------|------|--------|---------|
| 2026-04-07 | 전체 파트너 129명 | [키퍼메이트] 이벤트 조기 마감 안내 + 총 상금 60만원 새 이벤트 예고 | 129명 전원 성공 | `scripts/send-keepermate-event-closure.js` |

### 이메일 내용 요약 (2026-04-07)
- 첫 활동 인증 이벤트 → **4월 8일(화) 오후 12시** 조기 마감
- 기존 참여자 상품 순차 발송 예정
- 총 상금 60만원 새 이벤트 → **4월 9일(수)** 공개 예정
...
| 2026-04-01 | production | 광고주 활동지원 수정 버튼 내용 초기화 버그 수정 (plainTextToTiptap 변환, key prop 추가, null 저장 차단) + 카톡방/카페 가이드 콘텐츠 복구 (3,517자) | 성공 |
| 2026-04-07 | production | 이벤트 마감 안내 + 새 이벤트 예고 단체 이메일 발송 스크립트 추가 (129명 전원 발송 완료) | 성공 |
