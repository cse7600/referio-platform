...
export default function KakaoLoginButton({ redirectTo }: KakaoLoginButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 px-4 py-2.5 font-medium text-sm transition-opacity hover:opacity-90 active:opacity-75"
      style={{ backgroundColor: '#FEE500', color: 'rgba(0,0,0,0.85)', borderRadius: '12px' }}
    >
      {/* Kakao official symbol — speech bubble shape */}
