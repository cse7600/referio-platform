...
import { Megaphone, LayoutList, Plus, Trash2, Eye, EyeOff } from 'lucide-react'
    ...
    <div className="space-y-3">
      {posts.map((post) => {
        ...
        return (
          <Card
            key={post.id}
            className={`cursor-pointer ${!post.is_published ? 'opacity-60' : ''}`}
            onClick={() => onToggleExpand(isExpanded ? null : post.id)}
          >
